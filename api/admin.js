...
// they still hit /api/admin/approve, /api/admin/transcript-scan, etc.; Vercel
...
import { handleTranscriptBooks }  from "../lib/admin/transcript-books.js";
import { handleTranscriptScan }   from "../lib/admin/transcript-scan.js";
import { handleTranscriptApply }  from "../lib/admin/transcript-apply.js";
import { handleTranscriptFbfind } from "../lib/admin/transcript-fbfind.js";
import { handleTranscriptFbtext } from "../lib/admin/transcript-fbtext.js";
...
const ROUTES = {
  ...
  "users":              handleUsers,
  "transcript-books":   handleTranscriptBooks,
  "transcript-scan":    handleTranscriptScan,
  "transcript-apply":   handleTranscriptApply,
  "transcript-fbfind":  handleTranscriptFbfind,
  "transcript-fbtext":  handleTranscriptFbtext,
