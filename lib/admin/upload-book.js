...
//     title:    "Анна Каренина",
//     author:   "Лев Толстой",
//     category: "Novels" | "Novellas" | "Short Stories" | "Plays" | "Poetry" | "Religious Texts",
...
// Category is what the book IS; the folder is only where the file lands.
// All prose and drama share the "novel" folder — the distinction between
// Novels / Novellas / Short Stories / Plays lives in the manifest entry, not
// in the directory tree, so a re-classification never has to move a file.
const CATEGORY_TO_FOLDER = {
  "Novels":          "novel",
  "Novellas":        "novel",
  "Short Stories":   "novel",
  "Plays":           "novel",
  "Religious Texts": "novel",
  "Poetry":          "poetry",
  // Legacy spellings still accepted from older clients.
  "Works":         "novel",
  "Novel":         "novel",
  "Novella":       "novel",
  "Short Story":   "novel",
...
export async function handleUploadBook(req, res) {
  if (req.method !== "POST") {
