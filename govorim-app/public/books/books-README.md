...
| `category` | no | One of `Novel`, `Song Lyrics`, `Poetry`, `Short Stories`. Groups the book under that section in the library dropdown. Anything else (or missing) goes in an "Other" group at the bottom. |
